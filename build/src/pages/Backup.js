(function() {
  ...
  function Backup({ tasks, cats, checks, serviceState, user, meta, syncMeta, syncStatus, autoBackupDueAt, serverAhead, actions }) {
    ...
    return /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("h1", { style: { fontFamily: "Outfit", fontSize: 28, fontWeight: 800, margin: "0 0 8px", color: T.text } }, "백업"), /* @__PURE__ */ React.createElement("p", { style: { fontSize: 13, color: T.textMuted, marginBottom: 20 } }, "Google 로그인만으로 여러 기기 간 동기화/백업/복원을 지원합니다."), /* @__PURE__ */ React.createElement(
      ...
      /* @__PURE__ */ React.createElement("h3", { style: { fontSize: 15, fontWeight: 700, color: T.text, margin: "0 0 12px" } }, "Google 백업"),
      /* @__PURE__ */ React.createElement("div", { style: { fontSize: 13, color: T.text, marginBottom: 6 } }, "로그인 상태: ", user ? `${((_a = user.user_metadata) == null ? void 0 : _a.full_name) || "사용자"} (${user.email || "이메일 없음"})` : "미로그인"),
      /* @__PURE__ */ React.createElement("div", { style: { fontSize: 12, color: T.textMuted, marginBottom: 4 } }, "서버 마지막 백업: ", (meta == null ? void 0 : meta.exists) ? prettyDateTime(meta.updatedAtClient || meta.updatedAt) : "없음"),
      /* @__PURE__ */ React.createElement("div", { style: { fontSize: 12, color: T.textMuted, marginBottom: 4 } }, "서버 버전: ", (meta == null ? void 0 : meta.exists) ? meta.version || "-" : "없음"),
      /* @__PURE__ */ React.createElement("div", { style: { fontSize: 12, color: T.textMuted, marginBottom: 4 } }, "로컬 기준 버전: ", (syncMeta == null ? void 0 : syncMeta.baseVersion) || "없음"),
      /* @__PURE__ */ React.createElement("div", { style: { fontSize: 12, color: T.textMuted, marginBottom: 10 } }, "로컬 마지막 변경: ", prettyDateTime(syncMeta == null ? void 0 : syncMeta.localUpdatedAt)),
      !serviceState.ok && /* @__PURE__ */ React.createElement(
        "div",
        {
          style: {
            marginBottom: 12,
      ...
      user && (syncMeta == null ? void 0 : syncMeta.dirty) && autoBackupDueAt && !serverAhead && /* @__PURE__ */ React.createElement(
        "div",
        {
          style: {
            marginBottom: 12,
        ...
        "로컬 변경이 감지되었습니다. ",
        prettyDateTime(autoBackupDueAt),
        " 전후로 자동 백업됩니다."
      ),
      user && serverAhead && /* @__PURE__ */ React.createElement(
        "div",
        {
          style: {
            marginBottom: 12,
      ...
      /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 8, flexWrap: "wrap" } }, /* @__PURE__ */ React.createElement(
        ...
        "button",
        {
          ...
          disabled: !user || busy || !(meta == null ? void 0 : meta.exists),
          style: {
            padding: "10px 14px",
            borderRadius: 10,
            border: "none",
            background: !user || !(meta == null ? void 0 : meta.exists) ? T.textMuted : "#b45309",
            color: "#fff",
            fontWeight: 600,
            fontSize: 13,
            cursor: !user || busy || !(meta == null ? void 0 : meta.exists) ? "not-allowed" : "pointer"
          }
        },
        "강제 업로드"
      ), /* @__PURE__ */ React.createElement(
      ...
      (syncStatus == null ? void 0 : syncStatus.message) && /* @__PURE__ */ React.createElement(
        "div",
        {
          style: {
            marginTop: 14,
